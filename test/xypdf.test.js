...
test("ships a pinned public-GitHub NPX XYPDF without an embedded SDK bundle", () => {
  ...
  assert.equal(plugin.command, "npx -y github:weedooit/xyplug-infisical-sdk#v0.1.1");
